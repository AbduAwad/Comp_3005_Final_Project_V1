            ...
            for event in events:         
                ...
                if (event['type']['name'] == 'Starting XI'):
                    ...
                    if (type_name == 'Pass'):
                        ...
                        team_passes_summary_arr.append([event_id, team_name, season_name])
                        pass_recipients_arr.append([event_id, recipient_name, season_name])
                        player_through_balls_arr.append([event_id, player_name, season_name, technique_name])
                        team_through_balls_arr.append([event_id, team_name, season_name, technique_name])    
                    ...
                    if (type_name == 'Shot'):
                        ...
                        shots_summary_arr.append([event_id, team_name, season_name])
                        stats_bomb_arr.append([event_id, player_name, statsbomb_xg, season_name])
                        first_time_shots_arr.append([event_id, player_name, first_time, season_name])
                        player_shots_summary_arr.append([event_id, player_name, season_name])
                    ...
                    if (type_name == 'Dribble'):
                        ...
                        player_dribbles_arr.append([event_id, player_name, season_name, outcome_name])
                    ...
                    if (type_name == 'Dribbled Past'):
                        ...
                        dribbled_pasts_summary_arr.append([event_id, player_name, season_name])
