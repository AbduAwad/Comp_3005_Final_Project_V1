...
def find_matching_competition_and_season(matches_arr: list, match_id: int) -> tuple[int, int, str, str]:
    for match in matches_arr:
        if str(match[0]) == match_id:
            #1. competition id, 2. season id, 3. competition name, 4. season name
