...
def Q_1(conn, execution_time):
    ...
    query = """ SELECT player_name, AVG(statsbomb_xg) as avg_xg_score
                FROM Statsbombxg_2020_2021_La_Liga_Partition 
...
def Q_2(conn, execution_time):
    ...
    query = """ SELECT player_name, COUNT(*) as num_shots
                FROM Shots_2020_2021_La_Liga_Partition_players
                GROUP BY player_name
...
def Q_3(conn, execution_time):
    ...
    query = """ SELECT player_name, COUNT(*) first_time_shots
                FROM firstime_shots_La_Liga_2018_2019_2020_2021_True_Partition
                GROUP BY player_name
...
def Q_4(conn, execution_time):
    ...
    query = """ SELECT team_name, COUNT(*) as num_passes
                FROM Passes_2020_2021_La_Liga_Partition
                GROUP BY team_name
...
def Q_5(conn, execution_time):
    ...
    query = """ SELECT recipient_name, COUNT(*) as num_passes_received
                FROM Pass_recipients_2003_2004_Premier_League_Not_Null_Partition
...
def Q_6(conn, execution_time):
    ...
    query = """ SELECT team_name, COUNT(*) as num_shots
                FROM Shots_2003_2004_Premier_League_Partition
                GROUP BY team_name
                ORDER BY num_shots DESC"""
...
def Q_7(conn, execution_time):
    ...
    query = """ SELECT player_name, COUNT(*) as num_through_balls
                FROM through_balls_2020_2021_La_Liga_Standard_Partition
                GROUP BY player_name
...
def Q_8(conn, execution_time):
    ...
    query = """ SELECT team_name, COUNT(*) as num_through_balls
                FROM through_balls_2020_2021_La_Liga_Standard_Partition_team
                GROUP BY team_name
                ORDER BY num_through_balls DESC"""
...
def Q_9(conn, execution_time):
    ...
    query = """ SELECT player_name, COUNT(*) as num_completed_dribbles
                FROM Dribbles_2018_2019_2020_2021_La_Liga_Success_Partition
                GROUP BY player_name
...
def Q_10(conn, execution_time):
    ...
    query = """ SELECT player_name, COUNT(*) as dribbled_past
                FROM DribbledPasts_2020_2021_La_Liga_Partition
                GROUP BY player_name
